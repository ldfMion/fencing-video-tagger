...
const CLASSIFICATIONS: Record<ActionCode, ActionClassification> = {
  ...
  "C,R,R": { tacticalIntent: "defense", scoringDefAlt: "C" },
  "CR,R": { tacticalIntent: "offense", receivingDefAlt: "P" },
  "CR,R,R,R": { tacticalIntent: "offense", receivingDefAlt: "P" },
...
export function getScoringDefAlternative(
  action: ActionCode,
): DefAlternative | undefined {
  return CLASSIFICATIONS[action].scoringDefAlt;
}

export function getReceivingDefAlternative(
  action: ActionCode,
): DefAlternative | undefined {
